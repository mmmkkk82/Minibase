...
public class MinibaseParser extends Parser {
	...
	public static final int
		...
		WS=17;
	public static final int
		RULE_query = 0, RULE_head = 1, RULE_sumagg = 2, RULE_avgagg = 3, RULE_body = 4, RULE_atom = 5,
		RULE_relationalAtom = 6, RULE_comparisonAtom = 7, RULE_term = 8, RULE_variable = 9,
		RULE_constant = 10, RULE_cmpOp = 11;
	private static String[] makeRuleNames() {
		return new String[] {
			"query", "head", "sumagg", "avgagg", "body", "atom", "relationalAtom", "comparisonAtom",
